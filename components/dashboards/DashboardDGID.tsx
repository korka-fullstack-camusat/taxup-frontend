...
const STATUS_COLORS: Record<string, string> = {
  COMPLETED: '#10b981', PENDING: '#f59e0b', FAILED: '#ef4444', FLAGGED: '#f97316', UNDER_REVIEW: '#3b82f6',
};

const typeLabel: Record<string, string> = {
  TRANSFERT: 'Transfert', PAIEMENT: 'Paiement', DEPOT: 'Dépôt',
  RETRAIT: 'Retrait', TRANSFER: 'Transfert', PAYMENT: 'Paiement',
};

const fraudTypeLabel: Record<string, string> = {
  STRUCTURING: 'Fragmentation', 
  LARGE_AMOUNT: 'Montant important',
  VELOCITY: 'Fréquence anormale',
  ROUND_TRIPPING: 'Aller-retour suspect',
