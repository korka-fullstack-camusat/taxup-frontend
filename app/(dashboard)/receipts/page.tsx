      ...
      <main className="flex-1 p-6 space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Recus Fiscaux</h1>
              <p className="text-gray-500 text-sm mt-0.5">Historique et telechargement des recus fiscaux</p>
            </div>
          </div>
        </div>
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {filtered.map(r => (
                      <tr key={r.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right text-green-800 font-medium">{formatXOF(r.tax_amount)}</td>
                        ...
                        <td className="px-6 py-4 text-center">
                          {r.is_cancelled ? (
                            ...
                            <span className="text-xs text-green-700 bg-green-50 px-2.5 py-1 rounded-full font-medium">Valide</span>
                          )}
                        </td>
                        ...
                        <td className="px-6 py-4 text-center">
                          <button
                            ...
                            className="inline-flex items-center gap-1 text-xs text-green-700 hover:text-green-800 hover:bg-green-50 px-2.5 py-1.5 rounded-lg transition-colors"
                          >
